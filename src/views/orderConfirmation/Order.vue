...
const useMakeOrderEffect = (shopId, shopName, productList) => {
  ...
  const handleConfirmOrder = async (inCanceled) => {
    const products = []
...
export default {
  ...
  setup () {
    ...
    const { handleConfirmOrder } = useMakeOrderEffect(shopId, shopName, productList.value)
    const { handleSubmitClick, showConfirm } = useShowMarkEffect()
