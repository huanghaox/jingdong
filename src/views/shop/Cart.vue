<template>
  <div class="mask" v-if="calculations.total > 0 && showCart" @click="handleCartShowChange"></div>
  <div class="cart">
    <div class="product" v-if="calculations.total > 0 && showCart ">
...
export default {
  ...
  setup () {
    ...
    const {
      productList, cartList, calculations, setCartItemChecked,
